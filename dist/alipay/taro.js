...
/* harmony export */ });
/* unused harmony exports Ad, ArCamera, Audio, Block, Camera, Canvas, Checkbox, CheckboxGroup, ContactButton, CoverImage, CoverView, CustomWrapper, Form, Icon, Input, Label, LifeFollow, Lifestyle, LivePlayer, Lottie, Map, MovableArea, MovableView, NativeSlot, Navigator, PageContainer, PageMeta, Picker, PickerView, PickerViewColumn, Progress, Radio, RadioGroup, RichText, RootPortal, ShareElement, Slider, Slot, Swiper, SwiperItem, Switch, Textarea, Video, WebView */
const View = 'view';
const Icon = 'icon';
...
const components = {
  ...
  Video: {
    ...
    'floating-mode': (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('none'),
    enableNative: 'true',
    bindLoading: '',
    bindUserAction: '',
    bindStop: '',
...
const BUBBLE_EVENTS = new Set(['touchStart', 'touchMove', 'touchEnd', 'touchCancel', 'tap', 'longTap']);
const hostConfig = {
  initNativeApi,
  ...
  modifyRecursiveComponentConfig(componentConfig, {
    isCustomWrapper
  }) {
    // 修改组件的生命周期配置
