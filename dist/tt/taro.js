...
/***/ "./node_modules/@tarojs/plugin-platform-tt/dist/components-react.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@tarojs/plugin-platform-tt/dist/components-react.js ***!
  \**************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* unused harmony exports Ad, Audio, AwemeData, AwemeUserCard, Block, Camera, Canvas, Checkbox, CheckboxGroup, ConsumeCard, CoverImage, CoverView, CustomWrapper, Form, Icon, Input, Label, LivePlayer, Map, MovableArea, MovableView, NativeSlot, Navigator, OpenData, PayButton, Picker, PickerView, PickerViewColumn, Progress, Radio, RadioGroup, RateButton, RichText, RtcRoom, Slider, Slot, Swiper, SwiperItem, Switch, Textarea, Video, WebView */
const View = 'view';
const Icon = 'icon';
...
const ConsumeCard = 'consume-card';
const AwemeData = 'aweme-data';
const RateButton = 'rate-button';
const OpenData = 'open-data';
const AwemeUserCard = 'aweme-user-card';
...
function initNativeApi(taro) {
  (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.processApis)(taro, tt, {
    needPromiseApis,
    transformMeta
  });
}
...
const components = {
  ...
  Slider: {
    color: (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('#e9e9e9'),
    'selected-color': (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('#1aad19')
  },
  WebView: {
    'progressbar-color': (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('#51a0d8')
  },
  Video: {
    'play-btn-position': (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('center'),
  ...
  Ad: {
    fixed: _empty,
    type: (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('banner'),
    scale: '100'
  },
  Textarea: {
    'disable-default-padding': _false,
    'confirm-type': (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('return'),
    'confirm-hold': _false,
  ...
  AwemeData: {
    'aweme-id': _empty,
    type: (0,_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__.singleQuote)('avatar'),
...
/* harmony export */ });
/* unused harmony exports EMPTY_ARR, EventChannel, HOOK_TYPE, PLATFORM_CONFIG_MAP, PLATFORM_TYPE, Shortcuts, TaroHook, TaroHooks, animation, box, cacheDataGet, cacheDataHas, cacheDataSet, focusComponents, getPlatformType, getUniqueKey, hasOwn, indent, isBooleanStringLiteral, isWebPlatform, nestElements, nonsupport, queryToJson, setUniqueKeyToRoute, toKebabCase, touchEvents, unbox, voidElements */
